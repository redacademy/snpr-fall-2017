		...
		<div id="page" class="hfeed site">
			...
			<header id="masthead" class="site-header" role="banner">
				...
				<nav id="site-navigation" class="main-navigation" role="navigation">
					<p class="header-logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo get_template_directory_uri() . '/sos_assets/logo/svg/favicon.svg'?>" class="header-logo" alt="main site logo"></img></a></p>
